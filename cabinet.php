...
$offset = $limit * ($page-1);
$user = $_COOKIE['user'];
//$products = get_progs_for_user($limit, $offset, $user);
$products = get_progs($limit, $offset);
$total_pages = round(countRow('bought')/$limit, 0);
?>
                    ...
                    <?php if(IsOwn($product, $user)): ?>
                        <div class="product-card">
                            ...
                            <div class="card-caption">
                                ...
                                <?php if(isset($_COOKIE['user'])): ?>
                                <a href="<?=$product['link'] ?>" class="btn btn-info btn-block"
                                   data-id="<?=$product['id'] ?>">
                                    <i class="fas fa-cart-arrow-down"></i> Скачать
                                    <a/>
                                <a href ='https://dotnet.microsoft.com/en-us/download'>.NET CORE</a>
                                    <?php endif; ?>
                                    <?php endif; ?>
